...
class Args(argparse.ArgumentParser):
    ...
    def __init__(self, **overrides):
        ...
        # Data parameters
        self.add_argument('--challenge', choices=['singlecoil', 'multicoil'],default=['singlecoil'], required=True,
                          help='Which challenge')
        self.add_argument('--data-path', type=pathlib.Path, default='data/singlecoil_val/',required=True,
